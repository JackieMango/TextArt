...
// Constants for printable ASCII characters 
const int startASCII = 32;
const int lastASCII = 127;

// Constants for clearing menu options
const int MENU = 23, CLEAR = 90;


/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
/* NOTE: Your temporary canvas is a GLOBAL variable, which is not allowed in this course!
  And because you have used this global variable, the new code currently does not compile. */
  // Temporary canvas
